"""
Attack Success Evaluation for DeepSeek-VL2
...
OUT_CSV    = "<TO_INSERT>"
MODEL_ID   = "deepseek-ai/deepseek-vl2-small"   # tiny | small | full
SPLIT      = "train"
...
def ask_yes_no(image_path: str, color: str, category: str) -> bool | None:
    ...
    text = tokenizer.decode(output_ids[0].cpu().tolist(), skip_special_tokens=True).strip().upper()
